#Create a list to store these monthly expenses and using that find out,[2200,2350,2600,2130,2190]
...
import numpy as np
expense = np.array([2200,2350,2600,2130,2190])
#print(expense)
...
new_expense = np.append(expense, 1980);
#print(new_expense)

expense[3]=expense[3] - 200
#print('April new expense is' ,expense)
